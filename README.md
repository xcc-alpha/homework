...
- **辛成诚 202314010225**
  ...
  - 设计项目目录结构与版本控制方案
  - 编写核心代码
  - 基于 wos_export.xlsx 完成数据统计与分析

- **刘博林 202314010218**
  - 辅助数据检索，协助核对 WOS 导出字段
  - 维护 data/raw/ 目录，撰写最终分析报告
-
  - 数据清洗与预处理，运行去重与标准化脚本
  - 输出 data/processed/，记录清洗规则
-
  - 计量分析辅助：基于 CiteSpace 进行共被引与聚类验证
  - 提供 Python 分析结果对比
-
...
-刘博林 202314010218：辅助数据检索：协助核对 WOS 导出字段，维护 data/raw/ 目录，撰写最终分析报告
